        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
            {foundations.map((foundation, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-gray-800/80 to-gray-900/80 rounded-full px-3 py-3 sm:px-6 sm:py-4 md:px-8 md:py-6 backdrop-blur-sm transition-all duration-300 hover:shadow-[0_0_25px_rgba(59,130,246,0.4)] hover:scale-105 hover:bg-gradient-to-r hover:from-gray-700/90 hover:to-gray-800/90 cursor-pointer h-20 sm:h-24 md:h-28 w-full min-w-0 flex-shrink-0 border border-transparent hover:border-gray-600/50"
              >
