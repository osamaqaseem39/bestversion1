  ...
  return (
    <section className="py-20 bg-transparent relative overflow-hidden">
      ...
      <div className="relative w-full">
         ...
         <div className="absolute left-0 top-0 w-48 h-full bg-gradient-to-r from-black/60 to-transparent z-10 pointer-events-none"></div>
         
         {/* Right Gradient Overlay */}
         <div className="absolute right-0 top-0 w-48 h-full bg-gradient-to-l from-black/60 to-transparent z-10 pointer-events-none"></div>

                 {/* Navigation Arrows */}
         <button
           onClick={prevSlide}
           className="absolute left-16 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white hover:bg-gray-100 transition-all duration-300 flex items-center justify-center shadow-lg"
         >
          <svg 
          ...
          >
            ...
            />
                 ...
                 <button
           onClick={nextSlide}
           className="absolute right-16 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-white hover:bg-gray-100 transition-all duration-300 flex items-center justify-center shadow-lg"
         >
          <svg 
            className="w-5 h-5 text-gray-800" 
            fill="none" 
