...
const FAQSection = () => {
  ...
  return (
         <section id="faq" className="py-12 sm:py-16 lg:py-20 bg-transparent relative overflow-hidden">
       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                   {/* Section Headers */}
          <div className="text-left mb-8 sm:mb-12 lg:mb-16">
            <p className="text-white font-poppins uppercase tracking-normal mb-2 sm:mb-4" style={{ fontSize: '28px', fontWeight: '275', lineHeight: '132%', letterSpacing: '0%' }}>
              FAQS
            </p>
            ...
            {faqs.map((faq, index) => (
               ...
               >
                                 ...
                                 <button
                                   ...
                                   className="relative w-full px-4 sm:px-6 py-3 sm:py-4 text-left bg-white/10 hover:bg-white/20 transition-all duration-700 ease-out flex items-center justify-between group"
                                 >
                                   <span className="text-white font-poppins font-medium text-sm sm:text-base lg:text-lg transition-all duration-500 ease-out pr-2">
                                     {faq.question}
                                   </span>
                                   <svg
                                     className={`w-4 h-4 sm:w-5 sm:h-5 text-white transition-all duration-700 ease-out flex-shrink-0 ${
                ...
                <div className={`relative px-4 sm:px-6 py-1 bg-black/30 backdrop-blur-md transform transition-all duration-700 ease-out overflow-hidden ${
                      openIndex === index 
                        ? 'max-h-96 opacity-100' 
                        : 'max-h-0 opacity-0 py-0'
                    }`}>
                        <p className="text-gray-200 leading-relaxed font-poppins font-light text-sm sm:text-base">
                          {faq.answer}
                        </p>
                      </div>
              </div>
